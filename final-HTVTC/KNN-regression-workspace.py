...
recommended_combination, history = final_HTVTC_Tucker_ALS(eval_func=func, ranges_dict=ranges_dict, metric=metric, initial_known_fraction=0.17, assumed_rank=3, known_fraction_multiplier=1, max_completion_cycles=4, maxit_fctn=100)
