...
recommended_combination, history = final_HTVTC_Tucker_ALS(eval_func=func, ranges_dict=ranges_dict, metric=metric, initial_known_fraction=0.25, assumed_rank=2, known_fraction_multiplier=0.8, min_interval=0.25, max_completion_cycles=2, maxit_fctn=100)
