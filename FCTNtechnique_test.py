...
reconstructed_tensor_FCTN, _ = FCTN_TC(sparse_tensor, sampled_indices, max_R = max_R)
...
mse_ground_truth_FCTN = np.mean((ground_truth_tensor - reconstructed_tensor_FCTN.reshape(11, 2, 1, 11))**2)
...
print("DEBUG: ground_truth_tensor.shape         = \n ",ground_truth_tensor.shape)
print("DEBUG: completed_tensor_cross.shape      = \n", completed_tensor_cross.shape)
print("DEBUG: reconstructed_tensor_FCTN.shape   = \n ", reconstructed_tensor_FCTN.shape)
